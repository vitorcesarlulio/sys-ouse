...
if (isset($_POST['idPeopleEdit']) && !empty($_POST['idPeopleEdit'])) {
    ...
    $queryUpDatePeople = " UPDATE tb_pessoas SET pess_nome=:pess_nome, pess_sobrenome=:pess_sobrenome, pess_razao_social=:pess_razao_social, pess_nome_fantasia=:pess_nome_fantasia, 
    ...
    $upDatePeople->execute() ? $returnAjax = 'upDatePeople' : $returnAjax = 'noUpDatePeople';
