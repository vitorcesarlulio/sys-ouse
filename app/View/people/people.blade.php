...
<script src="<?= DIRJS . 'people/people.min.js' ?>"></script>
<script src="<?= DIRJS . 'people/edit-people-validation.min.js' ?>"></script>
<script src="<?= DIRJS . 'people/register-people-validation.min.js' ?>"></script>
