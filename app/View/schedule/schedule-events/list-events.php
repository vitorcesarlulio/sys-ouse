...
while($row = mysqli_fetch_array($result))
{
 ...
 $sub_array[] = '<div class="btn-group btn-group-sm"><a href="/agenda/eventos/editar?id='.$row["id"].'" class="btn btn-warning" name="viewEvent"><i class="fas fa-edit"></i></a><a href="#" class="btn btn-info" name="viewEvent"><i class="fas fa-eye"></i></a><button type="button" name="deleteEvent" class="btn btn-danger" id="'.$row["id"].'"><i class="fas fa-trash"></i></button></div>';
 $data[] = $sub_array;
}
