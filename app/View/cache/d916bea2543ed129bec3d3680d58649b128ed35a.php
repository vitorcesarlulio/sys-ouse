          ...
          <div class="modal-content">
            ...
            <div class="col-sm-4">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>CEP:</label>
                            <input type="text" class="form-control" id="cep" maxlength="8" placeholder="Enter ...">
                        </div>
                    </div>
                    <div class="col-sm-6>
                        <div class="form-group">
                    ...
                    <div class="col-sm-6" id="minhaDiv" style="display:none">
                        <div class="form-group">
                            <label>CNPJ:</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                    ...
                    <div class="col-sm-9" id="minhaDiv" style="display:none">
                        <div class="form-group">
                            <label>CPF:</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
...
<?php /**PATH C:\Apache24\htdocs\sys-ouse\app\View/cadastro/modals.blade.php ENDPATH**/ ?>